...
public class WidgetInteractionTests
{
    ...
    public void FloatingWidgetXaml_UsesThemeResourcesAndHasNoExactQuotaPrototype()
    {
        ...
        var widgetCode = File.ReadAllText(Find("src/CodexMeter/UI/FloatingWidget.xaml.cs"));
        ...
        var appCode = File.ReadAllText(Find("src/CodexMeter/App.xaml.cs"));
    ...
    {
        var tray = File.ReadAllText(Find("src/CodexMeter/UI/TrayController.cs"));
