...
public class TaskbarStatusLayoutTests
{
    ...
    public void BorderlessFullscreen_IgnoresTaskbarVisibleFlag()
    {
        ...
        var source = File.ReadAllText(Find("src/CodexMeter.Core/Codex/TaskbarStatusLayout.cs"));
    ...
    private static string FindStripWindow() => Find("src/CodexMeter/UI/TaskbarStatusStripWindow.xaml.cs");
