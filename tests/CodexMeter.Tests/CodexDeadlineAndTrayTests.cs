...
public class CodexDeadlineAndTrayTests
{
    ...
    {
        var app = Read("src/CodexMeter/App.xaml.cs");
    ...
    {
        var xaml = Read("src/CodexMeter/UI/SettingsWindow.xaml");
    ...
    private static string Read(string path)
    {
        ...
        while (dir is not null && !File.Exists(Path.Combine(dir.FullName, "CodexMeter.sln"))) dir = dir.Parent;
