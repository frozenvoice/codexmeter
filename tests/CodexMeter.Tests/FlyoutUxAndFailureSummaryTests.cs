...
public class FlyoutUxAndFailureSummaryTests
{
    ...
    {
        var source = File.ReadAllText(Find("src/CodexMeter/UI/TaskbarStatusStripWindow.xaml.cs"));
        var xaml = File.ReadAllText(Find("src/CodexMeter/UI/TaskbarStatusStripWindow.xaml"));
    ...
    {
        var xaml = File.ReadAllText(Find("src/CodexMeter/UI/FlyoutWindow.xaml"));
        var code = File.ReadAllText(Find("src/CodexMeter/UI/FlyoutWindow.xaml.cs"));
        var app = File.ReadAllText(Find("src/CodexMeter/App.xaml.cs"));
        Assert.False(FlyoutWindowState.HidesOnDeactivate);
    ...
    public void FlyoutCode_CloseHidesWithoutExit_AndDragWorksPinnedOrUnpinned()
    {
        ...
        var settingsUi = File.ReadAllText(Find("src/CodexMeter/UI/SettingsWindow.xaml"));
        ...
        var settingsCode = File.ReadAllText(Find("src/CodexMeter/UI/SettingsWindow.xaml.cs"));
        ...
        var settingsApp = File.ReadAllText(Find("src/CodexMeter.Core/Services/SettingsApplication.cs"));
        ...
        var settingsModel = File.ReadAllText(Find("src/CodexMeter.Core/Models/AppSettings.cs"));
    ...
    {
        var xaml = File.ReadAllText(Find("src/CodexMeter/UI/CoverageWindow.xaml"));
        var code = File.ReadAllText(Find("src/CodexMeter/UI/CoverageWindow.xaml.cs"));
