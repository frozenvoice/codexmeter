...
public class DevRunScriptGuardTests
{
    ...
    public void Script_PublishesToStagingBeforeTouchingLocal()
    {
        ...
        Assert.True(stopProcessIndex >= 0, "dev-run.ps1 does not stop the running CodexMeter process.");
    ...
    private static string FindRepoRoot()
    {
        ...
        return dir?.FullName ?? throw new DirectoryNotFoundException("Could not locate repo root (CodexMeter.sln) from " + AppContext.BaseDirectory);
    }
}
