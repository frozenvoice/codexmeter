...
public class CodexDeadlineAndTrayTests
{
    ...
    {
        var app = Read("src/CycleArc/App.xaml.cs");
    ...
    {
        var xaml = Read("src/CycleArc/UI/SettingsWindow.xaml");
    ...
    private static string Read(string path)
    {
        ...
        while (dir is not null && !File.Exists(Path.Combine(dir.FullName, "CycleArc.sln"))) dir = dir.Parent;
