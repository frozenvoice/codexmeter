...
public class WebViewDiagnosticRemovalTests
{
    ...
    public void AppAndSettings_NoLongerWireWebViewDiagnosticCallbacks()
    {
        ...
        var settings = File.ReadAllText(Find("src/CycleArc/UI/SettingsWindow.xaml.cs"));
        ...
        Assert.Contains("AuthTransportKind.WebView2", File.ReadAllText(Find("src/CycleArc/UI/WelcomeWindow.xaml.cs")), StringComparison.Ordinal);
    }
    ...
    public void WebView2FallbackTransport_RemainsAvailable()
    {
        ...
        var transport = File.ReadAllText(Find("src/CycleArc/WebView/WebViewTransport.cs"));
