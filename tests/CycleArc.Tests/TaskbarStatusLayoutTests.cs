...
public class TaskbarStatusLayoutTests
{
    ...
    public void BorderlessFullscreen_IgnoresTaskbarVisibleFlag()
    {
        ...
        var source = File.ReadAllText(Find("src/CycleArc.Core/Codex/TaskbarStatusLayout.cs"));
    ...
    private static string FindStripWindow() => Find("src/CycleArc/UI/TaskbarStatusStripWindow.xaml.cs");
