...
public class CompanionHostLifecycleTests
{
    ...
    {
        var pipeName = "CycleArcLifecycleTest-" + Guid.NewGuid().ToString("N");
    ...
    {
        var source = File.ReadAllText(Find("src/CycleArc.Core/Companion/CompanionPipeServer.cs"));
        ...
        var host = File.ReadAllText(Find("src/CycleArc.Core/Companion/NativeMessagingHost.cs"));
        ...
        var registration = File.ReadAllText(Find("src/CycleArc/Companion/CompanionRegistration.cs"));
    ...
    public void DesktopRetiresOwnedNativeRegistrationsInsteadOfInstallingExtension()
    {
        ...
        var cleanup = File.ReadAllText(Find("src/CycleArc/Services/LegacyCompanionCleanup.cs"));
        ...
        var project = File.ReadAllText(Find("src/CycleArc/CycleArc.csproj"));
