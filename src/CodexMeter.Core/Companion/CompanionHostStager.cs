...
{
    public const string HostFileName = "codexmeter-companion-host.exe";
    ...
    public static string EnsureStaged(string sourceHostPath, string? nativeHostRoot = null)
    {
        ...
        {
            throw new FileNotFoundException("codexmeter-companion-host.exe is missing", sourceHostPath);
        }
    ...
    public static IReadOnlyList<string> RequiredRuntimeFiles(string sourceHostPath)
    {
        ...
        {
            "codexmeter-companion-host.dll",
            "codexmeter-companion-host.deps.json",
            "codexmeter-companion-host.runtimeconfig.json",
            "CodexMeter.Core.dll"
        })
        {
