...
public static class CompanionHostManifest
{
        ...
        string? builtInExtensionId = null)
    {
        if (string.IsNullOrWhiteSpace(companionHostPath)
            ...
            || !string.Equals(Path.GetFileName(companionHostPath), "codexmeter-companion-host.exe", StringComparison.OrdinalIgnoreCase))
        {
        ...
        var manifest = new JsonObject
        {
            ...
            ["description"] = "CodexMeter ChatGPT companion",
