...
/// <summary>
/// Reads the CodexMeter Browser Companion extension's own manifest.json to recover
/// its deterministic extension ID, so CodexMeter never has to be told the ID by
