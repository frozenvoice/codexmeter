...
{
    public const string HostFileName = "cyclearc-companion-host.exe";
    ...
    public static string EnsureStaged(string sourceHostPath, string? nativeHostRoot = null)
    {
        ...
        {
            throw new FileNotFoundException("cyclearc-companion-host.exe is missing", sourceHostPath);
        }
    ...
    public static IReadOnlyList<string> RequiredRuntimeFiles(string sourceHostPath)
    {
        ...
        {
            "cyclearc-companion-host.dll",
            "cyclearc-companion-host.deps.json",
            "cyclearc-companion-host.runtimeconfig.json",
            "CycleArc.Core.dll"
        })
        {
