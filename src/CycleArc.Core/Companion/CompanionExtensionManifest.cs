...
/// <summary>
/// Reads the CycleArc Browser Companion extension's own manifest.json to recover
/// its deterministic extension ID, so CycleArc never has to be told the ID by
